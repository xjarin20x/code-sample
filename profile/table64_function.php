...
<?php
	...
	$keywords = array("herbaiha", "insectai", "fungikgai", "othpkgai");
	$all_stmt->execute();
	$all_stmt->store_result();
	...
	create_row("Other pesticides (kg or L AI/ha)", $iout['othpkgai'], 2);
	echo "</tbody>\n";
	echo "</table>\n";
...
<div><sup>b </sup><b>AI</b> - refers to active ingredient</div>
<br/>
