...
<div id="tableData">
<h3>Distribution of farmers by government support they wanted to avail</h3>
<br />
<?php
	...
	if($province==999){
		$all_stmt=$conn->prepare("SELECT COUNT(*) FROM (SELECT matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season FROM matrix_rectype1 JOIN matrix_gsupport WHERE matrix_rectype1.region = matrix_gsupport.region AND matrix_rectype1.province = matrix_gsupport.province AND matrix_rectype1.municipality = matrix_gsupport.municipality AND matrix_rectype1.barangay = matrix_gsupport.barangay AND matrix_rectype1.hh_number = matrix_gsupport.hh_number AND matrix_rectype1.season = matrix_gsupport.season AND matrix_rectype1.season = ? GROUP BY matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season) a");
		$all_stmt->bind_param("s", $season);
	}
	else{
		$all_stmt=$conn->prepare("SELECT COUNT(*) FROM (SELECT matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season FROM matrix_rectype1 JOIN matrix_gsupport WHERE matrix_rectype1.region = matrix_gsupport.region AND matrix_rectype1.province = matrix_gsupport.province AND matrix_rectype1.municipality = matrix_gsupport.municipality AND matrix_rectype1.barangay = matrix_gsupport.barangay AND matrix_rectype1.hh_number = matrix_gsupport.hh_number AND matrix_rectype1.season = matrix_gsupport.season AND matrix_rectype1.season = ? AND matrix_rectype1.province = ? GROUP BY matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season) a");
	...
	if($province==999){
		$all_stmt= $conn->prepare("SELECT gs.gsupport, COUNT(gs.gsupport) FROM (SELECT matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season, matrix_gsupport.gsupport FROM matrix_rectype1 JOIN matrix_gsupport WHERE matrix_rectype1.region = matrix_gsupport.region AND matrix_rectype1.province = matrix_gsupport.province AND matrix_rectype1.municipality = matrix_gsupport.municipality AND matrix_rectype1.barangay = matrix_gsupport.barangay AND matrix_rectype1.hh_number = matrix_gsupport.hh_number AND matrix_rectype1.season = matrix_gsupport.season AND matrix_rectype1.season = ? AND matrix_gsupport.gsupport IS NOT NULL) gs GROUP BY gs.gsupport ORDER BY COUNT(gs.gsupport) DESC");
		$all_stmt->bind_param("s", $season);
	}
	else{
		$all_stmt= $conn->prepare("SELECT gs.gsupport, COUNT(gs.gsupport) FROM (SELECT matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season, matrix_gsupport.gsupport FROM matrix_rectype1 JOIN matrix_gsupport WHERE matrix_rectype1.region = matrix_gsupport.region AND matrix_rectype1.province = matrix_gsupport.province AND matrix_rectype1.municipality = matrix_gsupport.municipality AND matrix_rectype1.barangay = matrix_gsupport.barangay AND matrix_rectype1.hh_number = matrix_gsupport.hh_number AND matrix_rectype1.season = matrix_gsupport.season AND matrix_rectype1.season = ? AND matrix_rectype1.province = ? AND matrix_gsupport.gsupport IS NOT NULL) gs GROUP BY gs.gsupport ORDER BY COUNT(gs.gsupport) DESC");
		$all_stmt->bind_param("ss", $season, $province);
	}
	...
	echo "<tbody>\n";
	create_headings("Government services wanted to avail by farmers", $headings);
