...
<div id="tableData">
<h3>Distribution of farmers by problem encountered in rice farming</h3>
<br />
<?php
	...
	if($province==999){
		$all_stmt=$conn->prepare("SELECT COUNT(*) FROM (SELECT matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season FROM matrix_rectype1 JOIN matrix_rproblem WHERE matrix_rectype1.region = matrix_rproblem.region AND matrix_rectype1.province = matrix_rproblem.province AND matrix_rectype1.municipality = matrix_rproblem.municipality AND matrix_rectype1.barangay = matrix_rproblem.barangay AND matrix_rectype1.hh_number = matrix_rproblem.hh_number AND matrix_rectype1.season = matrix_rproblem.season AND matrix_rectype1.season = ? GROUP BY matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season) a");
		$all_stmt->bind_param("s", $season);
	}
	else{
		$all_stmt=$conn->prepare("SELECT COUNT(*) FROM (SELECT matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season FROM matrix_rectype1 JOIN matrix_rproblem WHERE matrix_rectype1.region = matrix_rproblem.region AND matrix_rectype1.province = matrix_rproblem.province AND matrix_rectype1.municipality = matrix_rproblem.municipality AND matrix_rectype1.barangay = matrix_rproblem.barangay AND matrix_rectype1.hh_number = matrix_rproblem.hh_number AND matrix_rectype1.season = matrix_rproblem.season AND matrix_rectype1.season = ? AND matrix_rectype1.province = ? GROUP BY matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season) a");
	...
	if($province==999){
		$all_stmt= $conn->prepare("SELECT rp.rproblem, COUNT(rp.rproblem) FROM (SELECT matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season, matrix_rproblem.rproblem FROM matrix_rectype1 JOIN matrix_rproblem WHERE matrix_rectype1.region = matrix_rproblem.region AND matrix_rectype1.province = matrix_rproblem.province AND matrix_rectype1.municipality = matrix_rproblem.municipality AND matrix_rectype1.barangay = matrix_rproblem.barangay AND matrix_rectype1.hh_number = matrix_rproblem.hh_number AND matrix_rectype1.season = matrix_rproblem.season AND matrix_rectype1.season = ? AND matrix_rproblem.rproblem IS NOT NULL) rp GROUP BY rp.rproblem ORDER BY COUNT(rp.rproblem) DESC");
		$all_stmt->bind_param("s", $season);
	}
	else{
		$all_stmt= $conn->prepare("SELECT rp.rproblem, COUNT(rp.rproblem) FROM (SELECT matrix_rectype1.region, matrix_rectype1.province, matrix_rectype1.municipality, matrix_rectype1.barangay, matrix_rectype1.hh_number, matrix_rectype1.season, matrix_rproblem.rproblem FROM matrix_rectype1 JOIN matrix_rproblem WHERE matrix_rectype1.region = matrix_rproblem.region AND matrix_rectype1.province = matrix_rproblem.province AND matrix_rectype1.municipality = matrix_rproblem.municipality AND matrix_rectype1.barangay = matrix_rproblem.barangay AND matrix_rectype1.hh_number = matrix_rproblem.hh_number AND matrix_rectype1.season = matrix_rproblem.season AND matrix_rectype1.season = ? AND matrix_rectype1.province = ? AND matrix_rproblem.rproblem IS NOT NULL) rp GROUP BY rp.rproblem ORDER BY COUNT(rp.rproblem) DESC");
		$all_stmt->bind_param("ss", $season, $province);
	}
	...
	echo "<tbody>\n";
	create_headings("Common farm problems", $headings);
