...
<?php
	...
	if($province==999){
		$all_stmt= $conn->prepare("SELECT AVG(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS avg_appl, STDDEV_SAMP(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS stddev_appl FROM matrix_application JOIN matrix_rectype1 WHERE matrix_rectype1.region = matrix_application.region AND matrix_rectype1.province = matrix_application.province AND matrix_rectype1.municipality = matrix_application.municipality AND matrix_rectype1.barangay = matrix_application.barangay AND matrix_rectype1.hh_number = matrix_application.hh_number AND matrix_rectype1.season = matrix_application.season AND matrix_application.season = ? AND matrix_application.type = 'F'");
		$irri_stmt= $conn->prepare("SELECT AVG(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS avg_appl, STDDEV_SAMP(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS stddev_appl FROM matrix_application JOIN matrix_rectype1, matrix_irrigation WHERE matrix_rectype1.region = matrix_application.region AND matrix_rectype1.province = matrix_application.province AND matrix_rectype1.municipality = matrix_application.municipality AND matrix_rectype1.barangay = matrix_application.barangay AND matrix_rectype1.hh_number = matrix_application.hh_number AND matrix_rectype1.season = matrix_application.season AND matrix_rectype1.region = matrix_irrigation.region AND matrix_rectype1.province = matrix_irrigation.province AND matrix_rectype1.municipality = matrix_irrigation.municipality AND matrix_rectype1.barangay = matrix_irrigation.barangay AND matrix_rectype1.hh_number = matrix_irrigation.hh_number AND matrix_rectype1.season = matrix_irrigation.season AND matrix_application.season = ? AND matrix_application.type = 'F' AND (matrix_irrigation.irrigation_source = 1 OR matrix_irrigation.irrigation_source = 2 OR matrix_irrigation.irrigation_source = 3 OR matrix_irrigation.irrigation_source = 4 OR matrix_irrigation.irrigation_source = 5)");
		$rain_stmt= $conn->prepare("SELECT AVG(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS avg_appl, STDDEV_SAMP(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS stddev_appl FROM matrix_application JOIN matrix_rectype1, matrix_irrigation WHERE matrix_rectype1.region = matrix_application.region AND matrix_rectype1.province = matrix_application.province AND matrix_rectype1.municipality = matrix_application.municipality AND matrix_rectype1.barangay = matrix_application.barangay AND matrix_rectype1.hh_number = matrix_application.hh_number AND matrix_rectype1.season = matrix_application.season AND matrix_rectype1.region = matrix_irrigation.region AND matrix_rectype1.province = matrix_irrigation.province AND matrix_rectype1.municipality = matrix_irrigation.municipality AND matrix_rectype1.barangay = matrix_irrigation.barangay AND matrix_rectype1.hh_number = matrix_irrigation.hh_number AND matrix_rectype1.season = matrix_irrigation.season AND matrix_application.season = ? AND matrix_application.type = 'F' AND matrix_irrigation.irrigation_source = 0");
		$all_stmt->bind_param("s", $season);
		$irri_stmt->bind_param("s", $season);
		$rain_stmt->bind_param("s", $season);
	}
	else{
		$all_stmt= $conn->prepare("SELECT AVG(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS avg_appl, STDDEV_SAMP(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS stddev_appl FROM matrix_application JOIN matrix_rectype1 WHERE matrix_rectype1.region = matrix_application.region AND matrix_rectype1.province = matrix_application.province AND matrix_rectype1.municipality = matrix_application.municipality AND matrix_rectype1.barangay = matrix_application.barangay AND matrix_rectype1.hh_number = matrix_application.hh_number AND matrix_rectype1.season = matrix_application.season AND matrix_application.season = ? AND matrix_application.province = ? AND matrix_application.type = 'F'");
		$irri_stmt= $conn->prepare("SELECT AVG(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS avg_appl, STDDEV_SAMP(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS stddev_appl FROM matrix_application JOIN matrix_rectype1, matrix_irrigation WHERE matrix_rectype1.region = matrix_application.region AND matrix_rectype1.province = matrix_application.province AND matrix_rectype1.municipality = matrix_application.municipality AND matrix_rectype1.barangay = matrix_application.barangay AND matrix_rectype1.hh_number = matrix_application.hh_number AND matrix_rectype1.season = matrix_application.season AND matrix_rectype1.region = matrix_irrigation.region AND matrix_rectype1.province = matrix_irrigation.province AND matrix_rectype1.municipality = matrix_irrigation.municipality AND matrix_rectype1.barangay = matrix_irrigation.barangay AND matrix_rectype1.hh_number = matrix_irrigation.hh_number AND matrix_rectype1.season = matrix_irrigation.season AND matrix_application.season = ? AND matrix_application.province = ? AND matrix_application.type = 'F' AND (matrix_irrigation.irrigation_source = 1 OR matrix_irrigation.irrigation_source = 2 OR matrix_irrigation.irrigation_source = 3 OR matrix_irrigation.irrigation_source = 4 OR matrix_irrigation.irrigation_source = 5)");
		$rain_stmt= $conn->prepare("SELECT AVG(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS avg_appl, STDDEV_SAMP(IFNULL(matrix_application.seedbed_appl, 0) + IFNULL(matrix_application.preestab_appl, 0) + IFNULL(matrix_application.standing_appl, 0)) AS stddev_appl FROM matrix_application JOIN matrix_rectype1, matrix_irrigation WHERE matrix_rectype1.region = matrix_application.region AND matrix_rectype1.province = matrix_application.province AND matrix_rectype1.municipality = matrix_application.municipality AND matrix_rectype1.barangay = matrix_application.barangay AND matrix_rectype1.hh_number = matrix_application.hh_number AND matrix_rectype1.season = matrix_application.season AND matrix_rectype1.region = matrix_irrigation.region AND matrix_rectype1.province = matrix_irrigation.province AND matrix_rectype1.municipality = matrix_irrigation.municipality AND matrix_rectype1.barangay = matrix_irrigation.barangay AND matrix_rectype1.hh_number = matrix_irrigation.hh_number AND matrix_rectype1.season = matrix_irrigation.season AND matrix_application.season = ? AND matrix_application.province = ? AND matrix_application.type = 'F' AND matrix_irrigation.irrigation_source = 0");
		$all_stmt->bind_param("ss", $season, $province);
		$irri_stmt->bind_param("ss", $season, $province);
		$rain_stmt->bind_param("ss", $season, $province);
	}
