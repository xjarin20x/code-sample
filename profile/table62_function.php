...
<?php
	...
	echo "<tbody>\n";
	create_special_rows("Seeding rate", $headings, 2);
	...
	create_row("Seeds (kg/ha)", $iout['seedha'], 2);
	echo "</tbody>\n";
	echo "</table>\n";
